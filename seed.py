...
def main(session):
    # load_alist(session) # TODO check accuracy of existing geocoding? 
    # load_slist(session) # TODO need to get latlong, more automated method

# TODO Check this once loaded against the txt files I have (shape-escape)
